...
public record StudentQuestionSetResponse(String questionSetId, String materialId, String title, LocalDateTime dueAt, List<StudentQuestionResponse> questions) {
