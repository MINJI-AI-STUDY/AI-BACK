...
1. [핵심 코드 바로가기](#5-핵심-코드-바로가기)에서 AI 서버 경계, schoolId scope, 역할 gate, QA fallback 테스트를 먼저 확인합니다.
2. [아키텍처](#6-아키텍처)에서 Spring Boot 백엔드와 FastAPI AI 서비스의 책임 분리를 확인합니다.
3. [한계와 개선점](#12-한계와-개선점)에서 MVP 인증, AI 응답 품질, 운영 검증 한계를 확인합니다.
